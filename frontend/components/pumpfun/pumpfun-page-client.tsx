  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid gap-3 md:grid-cols-3 xl:grid-cols-6">
        ...
        <Stat label="신규 / 이주" value={`${data.stats.creates.toLocaleString()} / ${data.stats.migrations}`} sub={`피드 메시지 ${data.feed.messages.toLocaleString()} · 재연결 ${data.feed.reconnects}`} />
      </div>
